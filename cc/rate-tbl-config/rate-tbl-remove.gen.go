...
const CommandRateTblRemove cc.CommandID = 0x02
...
func NewRateTblRemove() cc.Command {
...
func (cmd RateTblRemove) CommandClassID() cc.CommandClassID {
	return 0x48
}

func (cmd RateTblRemove) CommandID() cc.CommandID {
	return CommandRateTblRemove
}

func (cmd RateTblRemove) CommandIDString() string {
	return "RATE_TBL_REMOVE"
}
