...
const CommandConfigurationSet cc.CommandID = 0x05
...
func (cmd *ConfigurationSet) UnmarshalBinary(data []byte) error {
	...
	cmd.DefaultToneIdentifier = payload[i]
	i++
...
func (cmd *ConfigurationSet) MarshalBinary() (payload []byte, err error) {
	...
	payload = append(payload, cmd.DefaultToneIdentifier)
