...
const CommandMeterTblHistoricalDataGet cc.CommandID = 0x0E

func init() {
	gob.Register(MeterTblHistoricalDataGet{})
	cc.Register(cc.CommandIdentifier{
		CommandClass: cc.CommandClassID(0x3D),
		Command:      cc.CommandID(0x0E),
		Version:      2,
	}, NewMeterTblHistoricalDataGet)
}

func NewMeterTblHistoricalDataGet() cc.Command {
...
type MeterTblHistoricalDataGet struct {
	...
	HistoricalDatasetRequested uint32
...
func (cmd MeterTblHistoricalDataGet) CommandClassID() cc.CommandClassID {
	return 0x3D
}

func (cmd MeterTblHistoricalDataGet) CommandID() cc.CommandID {
	return CommandMeterTblHistoricalDataGet
}

func (cmd MeterTblHistoricalDataGet) CommandIDString() string {
	return "METER_TBL_HISTORICAL_DATA_GET"
}

func (cmd *MeterTblHistoricalDataGet) UnmarshalBinary(data []byte) error {
	...
	cmd.HistoricalDatasetRequested = binary.BigEndian.Uint32(payload[i : i+3])
	i += 3
