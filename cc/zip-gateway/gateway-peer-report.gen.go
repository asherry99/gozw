...
const CommandGatewayPeerReport cc.CommandID = 0x06

func init() {
	gob.Register(GatewayPeerReport{})
	cc.Register(cc.CommandIdentifier{
		CommandClass: cc.CommandClassID(0x5F),
		Command:      cc.CommandID(0x06),
		Version:      1,
	}, NewGatewayPeerReport)
}

func NewGatewayPeerReport() cc.Command {
...
func (cmd GatewayPeerReport) CommandClassID() cc.CommandClassID {
	return 0x5F
}

func (cmd GatewayPeerReport) CommandID() cc.CommandID {
	return CommandGatewayPeerReport
}

func (cmd GatewayPeerReport) CommandIDString() string {
	return "GATEWAY_PEER_REPORT"
}

func (cmd *GatewayPeerReport) UnmarshalBinary(data []byte) error {
...
func (cmd *GatewayPeerReport) MarshalBinary() (payload []byte, err error) {
	payload = make([]byte, 2)
	...
	payload = append(payload, cmd.PeerCount)
