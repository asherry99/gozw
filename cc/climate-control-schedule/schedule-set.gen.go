...
const CommandScheduleSet cc.CommandID = 0x01

func init() {
	gob.Register(ScheduleSet{})
...
func NewScheduleSet() cc.Command {
	return &ScheduleSet{}
}
...
func (cmd ScheduleSet) CommandClassID() cc.CommandClassID {
	return 0x46
}

func (cmd ScheduleSet) CommandID() cc.CommandID {
	return CommandScheduleSet
}

func (cmd ScheduleSet) CommandIDString() string {
	return "SCHEDULE_SET"
}

func (cmd *ScheduleSet) UnmarshalBinary(data []byte) error {
