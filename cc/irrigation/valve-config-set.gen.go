...
const CommandValveConfigSet cc.CommandID = 0x0A

func init() {
	gob.Register(ValveConfigSet{})
...
func NewValveConfigSet() cc.Command {
	return &ValveConfigSet{}
}

// <no value>
type ValveConfigSet struct {
	Properties1 struct {
		MasterValve bool
	}
...
func (cmd ValveConfigSet) CommandClassID() cc.CommandClassID {
	return 0x6B
}

func (cmd ValveConfigSet) CommandID() cc.CommandID {
	return CommandValveConfigSet
}

func (cmd ValveConfigSet) CommandIDString() string {
	return "IRRIGATION_VALVE_CONFIG_SET"
}

func (cmd *ValveConfigSet) UnmarshalBinary(data []byte) error {
...
func (cmd *ValveConfigSet) MarshalBinary() (payload []byte, err error) {
	payload = make([]byte, 2)
