...
const CommandTimeOffsetSet cc.CommandID = 0x0D

func init() {
	gob.Register(TimeOffsetSet{})
...
func NewTimeOffsetSet() cc.Command {
...
func (cmd TimeOffsetSet) CommandClassID() cc.CommandClassID {
	return 0x4E
}

func (cmd TimeOffsetSet) CommandID() cc.CommandID {
	return CommandTimeOffsetSet
}

func (cmd TimeOffsetSet) CommandIDString() string {
	return "SCHEDULE_ENTRY_LOCK_TIME_OFFSET_SET"
}

func (cmd *TimeOffsetSet) UnmarshalBinary(data []byte) error {
...
func (cmd *TimeOffsetSet) MarshalBinary() (payload []byte, err error) {
	payload = make([]byte, 2)
